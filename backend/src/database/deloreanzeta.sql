...
--
-- Host: localhost    Database: deloreanzeta
-- ------------------------------------------------------
...
INSERT INTO `categoria` VALUES (1,'Remeras'),(6,'funkos');
...
CREATE TABLE `venta` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `comprador` FOREIGN KEY (`id`) REFERENCES `usuario` (`id`),
  CONSTRAINT `producto` FOREIGN KEY (`id`) REFERENCES `producto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
