...
import { validateRegister, validateRegisterUpdate } from "../middlewares/users.validator";
...
router.patch("/:id", validateRegisterUpdate, [/*checkJwt*/], UserController.editUser);
